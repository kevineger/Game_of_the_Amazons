...
public class SuccessorFunction2 {
    ...
    public ArrayList<SearchNode> getSuccessors(BoardLogic state) {
        ...
        for(int i=0; i<queens.length; i++) {
            ...
            for(int j=0; j<queenMoves.size(); j++) {
                ...
                for(int k=0; k<arrowShots.size(); k++) {
                    ...
                    //making search node
                    move M = new move(tempBoard.friendly[i].rowPos,tempBoard.friendly[i].colPos,tempBoard.friendly[i]);
...
//                    newState.arrows.set(size-1,null);
    ...
    public ArrayList<SearchNode> enemySuccesor(BoardLogic state) {
        ArrayList<SearchNode> successors = new ArrayList<SearchNode>();
        Queen[] queens = state.getEnemies();
        int stateCount = 0;
        ...
        for(int i=0; i<queens.length; i++) {
            ...
            for(int j=0; j<queenMoves.size(); j++) {
                ...
                BoardLogic tempBoard = state.deepCopy();
                // System.out.println("Deep Copy is: \n"+tempBoard.toString());
                tempBoard.enemies[i].rowPos = queenMoves.get(j).rowPos;
                tempBoard.enemies[i].colPos = queenMoves.get(j).colPos;
                tempBoard.updateAfterMove();
